 ...
 */
public class metodoDoolittle extends javax.swing.JFrame {

    /**
     * Creates new form metodoDoolittle
     */
    public metodoDoolittle() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Método de Doolittle");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(metodoDoolittle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new metodoDoolittle().setVisible(true);
            }
        });
    }
    ...
    public void doolittle(double[][] matrizA, double[] vectorB) {
        int n = matrizA.length;
        double[][] matrizL = new double[n][n];
        double[][] matrizU = new double[n][n];

        //iniciamos L y U, L con 1's en la diagonal
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                if (i == j) {
                    matrizL[i][j] = 1;
        ...
        for (int i = n - 2; i >= 0; i--) {
            double sumaAux = 0;
            for (int j = n - 1; j > i; j--) {
                sumaAux += x[j] * matrizU[i][j];
                x[i] = Double.parseDouble(rd.format((y[i] - sumaAux) / matrizU[i][i]));
            }
